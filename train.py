...
def main():
    ...
    # Do deep learning!
    learn(model, trainloader, testloader, epochs, print_every, criterion, optimizer, device)
...
def learn(model, trainloader, testloader, epochs, print_every, criterion, optimizer, device='cpu'):
    epochs = epochs
    steps = 0
